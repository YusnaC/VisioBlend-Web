    ...
    <div className="App">
      <div className="title-and-boxes">
        <div className="div-wrapper">
          ...
          >
            <h1 className="title fw-bold">Marketing Design</h1>
        ...
        >
          Membantu dalam pembuatan desain yang efektif dan menarik untuk
          kebutuhan pemasaran.
        </p>
        <div className="box-container">
          <div className="box-services">
            <div className="detail">
              ...
              <div className="box-content">
                <ul>
                  <li>Desain Konten Feed.</li>
                  <li>Desain Konten Story.</li>
                </ul>
              </div>
              <div className="price">
          ...
          <div className="box-services">
            <div className="detail">
              ...
              <div className="box-content">
                <ul>
                  <li>Desain Konten Feed & Story.</li>
